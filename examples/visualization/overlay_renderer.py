...
Example-only: cv2 drawing/overlay code has no place in the installable
library (depth_perception_engine has no GUI dependency at all — see its
pyproject.toml). This module is for examples/live_demo.py's on-screen
display only.
"""
...
class OverlayRenderer:
    ...
    def render_scene_grid(
        ...
        """Draw the traversability grid: per-region classification, confidence,

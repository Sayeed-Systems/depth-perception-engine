...
This sits after depth estimation and before any flight-control layer:
    ...
    Depth Map Generator -> SceneInterpreter -> (VelocityPlanner / flight controller)
...
from perception.region_analyzer import RegionAnalyzer
...
class SceneInterpreter:
    """Grid-based perception-fusion layer producing a global navigation decision."""

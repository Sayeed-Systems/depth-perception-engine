...
# ---------------------------------------------------------------------------
# Manual test — live disparity preview
# ---------------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    engine = DisparityEngine(min_disparity=0, num_disparities=128, block_size=11)
    ...
    try:
        while True:
            ...
            try:
                ...
                _, disp_vis = engine.compute_disparity(left, right)
            ...
            cv2.imshow("Disparity Map", disp_bgr)
